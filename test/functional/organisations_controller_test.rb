...
class OrganisationsControllerTest < ActionController::TestCase
  ...
  test "should create organisation" do
    assert_difference('Organisation.count') do
      post :create, organisation: { content: @organisation.content, name: @organisation.name, website_url: @organisation.website_url }
    end
  ...
  test "should update organisation" do
    put :update, id: @organisation, organisation: { content: @organisation.content, name: @organisation.name, website_url: @organisation.website_url }
    assert_redirected_to organisation_path(assigns(:organisation))
  end
